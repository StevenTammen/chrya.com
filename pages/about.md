...
In short, Chrya was chosen since it can be used as a shorthand way of referring to this ministry without calling to mind any other associations whatsoever. As a "blank slate" name, it can be thrown about loosely without worrying that somebody will disregard the site out of hand because of the name's connections to something troubling.
